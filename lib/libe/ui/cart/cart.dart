...
import 'package:shoestores/libe/ui/cart/bloc/cart_bloc.dart';
import 'package:shoestores/libe/ui/cart/cart_item.dart';
import 'package:shoestores/libe/ui/cart/price_info.dart';
import 'package:shoestores/libe/ui/shipping/shipping.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    ...
    cartRepository.addListener(cartNeedsRefresh);
  }
  ...
  void dispose() {
    ...
    cartRepository.removeListener(cartNeedsRefresh);
    cartBloc?.close();
