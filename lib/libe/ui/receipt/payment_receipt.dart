...
import 'package:shoestores/libe/ui/receipt/bloc/payment_receipt_bloc.dart';
import 'package:shoestores/libe/ui/root.dart';
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () {
                        ...
                        changeSelectedTabItem.sink.add(homeIndex);
                      },
