...
import 'package:shoestores/libe/ui/list/bloc/product_list_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocProvider<ProductListBloc>(
          create: (context) {
            bloc = ProductListBloc(getIt<IProductRepository>())
                    ...
                    Expanded(
                      child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return ProductItem(
                              product: product,
                              imageSquare: viewType == ViewType.list,
